...
> English version generated from the Romanian README. Commands, examples, tables, metrics, datasets and links are preserved from the original documentation.


## Overview

Generare automată de text in Romanian cu GPT-2, trained și evaluat pe corpusuri de news.

README-ul pastreaza informatiile practice ale proiectului: datale folosite, modelele, resultsle si pasii de rulare, acolo unde acestea sunt disponibile in repository.
...
Daca exista results experimentale, acestea trebuie documentate in aceasta sectiune cu metricile si configuratia folosita.
